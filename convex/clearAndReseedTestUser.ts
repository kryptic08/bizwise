...
/**
 * Clear all data for test@bizwise.com and reseed with realistic data
 */
export const clearAndReseedTestUser = mutation({
  args: {},
  handler: async (ctx) => {
    ...
    // Delete expense items and expenses
    ...
    return {
      success: true,
      message: `Cleared and reseeded data for ${testEmail}`,
