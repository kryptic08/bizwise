...
<body>
  <!-- Header Image -->
  <img src="data:image/png;base64,${headerImage}" alt="Header" class="header-image" />
  ...
  <!-- Footer Image -->
  <img src="data:image/png;base64,${footerImage}" alt="Footer" class="footer-image" />
...
export async function generatePDFReport(
  ...
  try {
    ...
    const headerFile = new File(headerAsset.localUri || headerAsset.uri);
    const headerBase64 = await headerFile.base64();

    const footerFile = new File(footerAsset.localUri || footerAsset.uri);
    const footerBase64 = await footerFile.base64();
